                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 border-b border-gray-200">
                            ...
                            <div x-show="!loading && upcomingAppointments.length === 0" class="text-center py-8">
                                ...
                                <div class="mt-6">
                                    <button @click="$store.bookingModal.open()" type="button" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-accent-500 hover:bg-accent-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent-500">
