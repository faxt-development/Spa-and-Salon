...
<div class="container mx-auto px-4 py-8" x-data="payrollRecord()" x-init="init()">
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="space-x-2">
            ...
            <a href="{{ route('payroll.records.generate', ['employee' => $payrollRecord->employee_id, 'start' => $payrollRecord->pay_period_start, 'end' => $payrollRecord->pay_period_end]) }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                Generate PDF
            </a>
        </div>
    </div>
