                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-blue-700">
                                    You haven't purchased any gift cards yet. <a href="{{ route('gift-cards.purchase') }}" class="font-medium text-blue-700 hover:text-blue-600">Purchase a gift card</a> to get started.
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach($giftCards as $giftCard)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">{{ $giftCard->code }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">{{ $giftCard->recipient_name }}</div>
                                            <div class="text-sm text-gray-500">{{ $giftCard->recipient_email }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">${{ number_format($giftCard->amount, 2) }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">${{ number_format($giftCard->balance, 2) }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('gift-cards.show', $giftCard) }}" class="text-indigo-600 hover:text-indigo-900 mr-4">View</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
