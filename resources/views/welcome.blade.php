    ...
    <div class="flex flex-col min-h-full">
        ...
        <div class="bg-primary-500 text-white text-center py-2 px-4">
            <p class="text-sm md:text-base">
                ...
                <a href="{{ route('guest.booking.index') }}"  class="underline hover:no-underline font-medium text-accent-200 hover:text-accent-600">Click here to book an appointment as a customer</a>.
            </p>
        </div>
        ...
        <section id="testimonials" class="py-16 bg-gradient-to-b from-white to-gray-50 dark:from-gray-800 dark:to-gray-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 transition-all hover:shadow-xl">
                        <div class="flex items-center mb-4">
                            <div class="h-12 w-12 rounded-full bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center text-blue-600 dark:text-blue-300 font-bold text-xl mr-4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
