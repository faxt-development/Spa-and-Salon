                ...
                <div class="md:flex md:items-center md:justify-between mb-6">
                    ...
                    <div class="mt-4 flex md:mt-0 md:ml-4">
                        @if($campaign->isDraft())
                            ...
                            <form action="{{ route('admin.email-campaigns.send', $campaign) }}" method="POST" class="ml-3">
                                @csrf
                                <button type="submit"
                        ...
                        @elseif($campaign->isScheduled())
                            <form action="{{ route('admin.email-campaigns.cancel', $campaign) }}" method="POST" class="ml-3">
                                @csrf
                                @method('PATCH')
                                <button type="submit"
                        ...
                        @if($campaign->isDraft() || $campaign->isScheduled())
                            <form action="{{ route('admin.email-campaigns.destroy', $campaign) }}" method="POST" class="ml-3">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
