        ...
        <div class="flex flex-col lg:flex-row gap-6">
            <div class="lg:w-1/3">
                ...
                <div class="space-y-4">
                    ...
                    <div class="staff-card p-4 border rounded-lg hover:bg-blue-50 cursor-pointer transition-colors"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        staffCards.forEach(card => {
            card.addEventListener('click', function() {
                ...
                staffCards.forEach(c => c.classList.remove('bg-blue-100', 'border-blue-500'));
        ...
        document.getElementById('availability-form').addEventListener('submit', function(e) {
            ...
            // The form will POST to the route we defined and the controller will handle the update
            
            // For better UX, we could use fetch API to submit the form asynchronously
            // But for simplicity, we'll use the standard form submission for now
            
            // If you want to implement AJAX submission later, you can use this code:
            /*
            e.preventDefault();
            ...
            .then(data => {
                if (data.success) {
                    ...
                    const staffMember = staffData.find(s => s.id == staffId);
                    if (staffMember) {
                        staffMember.work_days = Array.from(formData.getAll('work_days[]'));
                        staffMember.work_start_time = formData.get('work_start_time');
                        staffMember.work_end_time = formData.get('work_end_time');
