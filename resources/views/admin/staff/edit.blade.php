                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-text-input id="first_name" name="first_name" type="text" class="mt-1 block w-full" :value="old('first_name', $staff->first_name)" required autofocus />
                                    </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="position" name="position" type="text" class="mt-1 block w-full" :value="old('position', $staff->position)" required />
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    @if ($staff->profile_image)
                                        <div class="mt-2 mb-2">
                                            <img src="{{ asset('storage/' . $staff->profile_image) }}" alt="{{ $staff->full_name }}" class="h-20 w-20 object-cover rounded-full">
                                        </div>
                                    @endif
                                    <input id="profile_image" name="profile_image" type="file" class="mt-1 block w-full" accept="image/*" />
                                    <p class="mt-1 text-xs text-gray-500">{{ __('Leave empty to keep the current image') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="mt-4">
                                    ...
                                    <select id="role" name="role" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                                        ...
                                        @foreach ($roles as $role)
                                            <option value="{{ $role->id }}" {{ (old('role') == $role->id || ($staff->user && $staff->user->roles->contains($role->id))) ? 'selected' : '' }}>
                                ...
                                <div class="mt-4">
                                    <label for="active" class="inline-flex items-center">
                                        <input id="active" name="active" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" {{ old('active', $staff->active) ? 'checked' : '' }}>
                                ...
                                <div class="mt-4">
                                    <label for="is_employee" class="inline-flex items-center">
                                        <input id="is_employee" name="is_employee" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" {{ $staff->employee ? 'checked' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="mt-2 grid grid-cols-2 gap-2">
                                        @php
                                            $workDays = old('work_days', $staff->work_days) ?? [];
                                        ...
                                        @foreach(['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'] as $day)
                                            <label class="inline-flex items-center">
                                                <input type="checkbox" name="work_days[]" value="{{ $day }}" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" {{ in_array($day, $workDays) ? 'checked' : '' }}>
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="commission_rate" name="commission_rate" type="number" step="0.01" min="0" max="100" class="mt-1 block w-full" :value="old('commission_rate', $staff->commission_rate)" />
                                </div>
                            </div>
                        </div>
