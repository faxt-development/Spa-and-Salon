        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-2xl font-semibold text-gray-800">Edit Permission: {{ $permission->display_name ?? $permission->name }}</h2>
                    <a href="{{ route('admin.permissions.show', $permission) }}" class="text-sm text-gray-600 hover:text-gray-900">
                        &larr; Back to Permission
                    </a>
                </div>
                ...
                @if(!$permission->roles->contains('name', 'admin')) {{-- Prevent deletion of admin-related permissions --}}
                        ...
                        <div class="bg-red-50 border-l-4 border-red-500 p-4">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-red-600">
                                        <p>Once you delete a permission, there is no going back. Please be certain.</p>
                                        <form action="{{ route('admin.permissions.destroy', $permission) }}" method="POST" class="mt-4">
                                            @csrf
                                            @method('DELETE')
