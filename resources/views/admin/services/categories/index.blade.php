...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden mb-6">
        <div class="p-4 border-b">
            <form action="{{ route('admin.services.categories') }}" method="GET" class="flex items-center">
                ...
                @if($search)
                    <a href="{{ route('admin.services.categories') }}" class="ml-2 text-gray-600 hover:text-gray-800">
                        Clear
                    </a>
                @endif
            </form>
