...
<div class="container mx-auto px-4 py-6">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Edit Service Package</h1>
    </div>
        ...
        <form action="{{ route('admin.services.packages.update', $package) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" name="discount_percentage" id="discount_percentage" value="{{ old('discount_percentage', $package->discount_percentage) }}" step="0.01" min="0" max="100"
            ...
            <div class="mt-6">
                ...
                <textarea name="description" id="description" rows="3"
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">{{ old('description', $package->description) }}</textarea>
            </div>
            ...
            <div class="mt-6">
                ...
                <select name="services[]" id="services" multiple required
                    ...
                    @foreach($services as $service)
                        <option value="{{ $service->id }}" {{ in_array($service->id, old('services', $package->services->pluck('id')->toArray())) ? 'selected' : '' }}>
