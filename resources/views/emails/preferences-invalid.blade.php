        ...
        <div class="mt-8 bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    The preferences link you used is invalid or has expired.
                </p>

                <div class="mt-6">
                    <p class="text-sm text-gray-500">
                        Please check that you've used the most recent link from our emails, or contact our support team for assistance.
                    </p>
                    ...
                    <p class="mt-4 text-sm text-gray-500">
                        Or <a href="{{ route('login') }}" class="font-medium text-blue-600 hover:text-blue-500">sign in</a> to manage your account preferences.
                    </p>
                </div>
